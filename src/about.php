...
Sur la page d’accueil, vous trouverez plusieurs boutons : « browse » qui permet de naviguer dans l’intégralité de l’archive, « by year » qui permet de trier les vidéos par année d’upload sur YouTube, et « channels » qui permet de trier les vidéos par auteurice. Un bouton « random » est également présent, permettant de visionner des vidéos aléatoirement. Une barre de recherche configurable est également présente et permet de rechercher dans plusieurs champs au choix. Sur la page d’une vidéo, vous trouverez la vidéo dans la plus haute qualité possible, ainsi que la date d’archivage, son statut, et toutes les métadonnées qui en font une vidéo YouTube : titre, description, nombre de vues, de likes, et les commentaires. <br class="brabout" />
Le site est conçu de façon à faciliter toute démarche de recherche qui aurait pour objet les YTPMV/音MAD. Cette archive est une vidéothèque et un outil, créé avec la volonté d’historiser les vidéos, leur contexte, et une partie des interactions de leur communauté. L’archivage exhaustif permet d’identifier clairement les vidéos, leurs auteurices, leurs dates de création, la description donne également souvent des informations utiles. On peut également consulter les dynamiques communautaires à travers les commentaires devenus statiques et pouvant maintenant servir de matériau brut. La recherche et le système de tri sont pensés pour être le plus transparent possibles, afin de permettre de trouver le plus facilement possible ce que l’on cherche. Tout le contenu du site est téléchargeable directement. Une case à cocher dans la navigation permet d’afficher directement les vidéos qui ont été supprimées de YouTube. L’objectif est de pouvoir replacer au maximum les vidéos dans leurs contextes, car une vidéo YouTube est souvent un fichier mp4, mais toujours aussi un évènement et un lieu social virtuel.
        </p>
</div>
    </body>
</html>
